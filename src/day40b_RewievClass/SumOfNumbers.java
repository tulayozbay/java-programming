...
public class SumOfNumbers {
    ...
    public static void main(String[] args) {
        System.out.println(getSumFromString("a5bc12def100g"));//bunun sonuna g koyup koymama ile ilgili aciklamayi dinle istersen 04/26/2021
    }
